...
class FarmersControllerTest < ActionController::TestCase
  ...
  test "should create farmer" do
    assert_difference('Farmer.count') do
      post :create, farmer: { email: @farmer.email, name: @farmer.name, password: @farmer.password, phone: @farmer.phone }
    end
  ...
  test "should update farmer" do
    patch :update, id: @farmer, farmer: { email: @farmer.email, name: @farmer.name, password: @farmer.password, phone: @farmer.phone }
    assert_redirected_to farmer_path(assigns(:farmer))
  end
